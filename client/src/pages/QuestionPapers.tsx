  ...
  return (
    <Layout >
      ...
      >
        ...
        >
          <section
            className='w-full relative py-8 md:w-1/3 h-full overflow-y-auto space-y-4 border-r'
          >
            ...
            >
              <main
                className='bg-white p-4 rounded-md w-11/12 shadow-lg'
              >
                <h3
                ...
                <form
                  onSubmit={handle_paper_schedule_action}
                  className='py-4'
                >
                  <hr />
                  <section
                  ...
                  <hr />
                  <section
                    className='flex mb-3 py-3 items-center'
                  >

                    <div className='w-1/2 p-2'>
                      <label htmlFor="year">Standard/year</label>
                      <input className='w-full border py-2 px-4 rounded-lg' type="number" name='year' />
                    </div>
                  ...
                  <section
                    className='flex bg-slate-100 pb-4 mt-2 rounded-md items-center'
                  >

                    <div className='w-1/2 p-2'>
                      <label htmlFor="year">Date</label>
                      <input className='w-full border py-2 px-4 rounded-lg' type="date" name='date' />
                    </div>

                    <div className='w-1/2 p-2'>
                      <label htmlFor="year">Time </label>
                      <input className='w-full border py-2 px-4 rounded-lg' type="time" name='time' />
                    </div>
                  </section>
                  <main
                    className='flex justify-end mt-6 py-2 px-1 space-x-4'
                  >
                    <button
                    ...
                    <button
                      className='border border-green-600 text-white bg-green-500 px-4 py-2 rounded-lg'
                    >
                      Schedule
                    </button>
                  </main>
            ...
            {
              loading && <div
                className='py-3 bg-slate-600/10 w-11/12 mx-auto rounded-sm text-slate-600 font-  px-6'
              >
                <h4>
                  Loading...
                </h4>
            ...
            }
            {
              ...
              <div
                className='py-3 bg-red-600/10 w-11/12 mx-auto rounded-sm text-red-600 font-medium px-6'
              >
                <h4>
                  No papers found.
                </h4>
...

            {
              !loading && paper?.map((data) =>
                ...
                >
                  <summary
                    className='bg-slate-200 cursor-pointer py-2 px-6 flex justify-between rounded-md'
                  >
                    <span
                      className='underline '
                    >
          ...
          <section
            className='w-full bg-white h-full flex justify-center overflow-y-auto md:w-2/3 border-l'
          >
