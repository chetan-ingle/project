export default function alert_examiner({
  name,
  subject,
  institute,
  address,
  ...
  <ul>
   ${subject
    ...
    </div><p>your credentials are User id:${email}, password:${password}</p><p>Please login here,<a href="${
    process.env.EXAMINER_LOGIN_LINK
